...
const VMListForm: React.FunctionComponent<Props> =
  ({data, selectionData, navigate}) => {
    return (
      <React.Fragment>
        <ButtonToolbar>
          <ButtonGroup size="lg">
...
/*
class VMList extends React.PureComponent<RouteComponentProps> { // eslint-disable-line react/prefer-stateless-function
